...
% Condition 4 - Erroneous

matlabbatch{1}.spm.stats.fmri_spec.sess.cond(4).name = 'erroneous';
erroneous_onset = importdata(fullfile(timing_path, 'erroneous_trials_onset'));
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(4).onset = erroneous_onset;
