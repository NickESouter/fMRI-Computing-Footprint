...
% Defines path to our input data, and to SPM12

func_path =  '<full path redacted>/SPM/CNP_SPM/SUBNUM/func/';
anat_path =  '<full path redacted>/SPM/CNP_SPM/SUBNUM/anat/';

SPM_path = '<full path redacted>/SPM_Cluster/spm12/';

% Realign: Estimate & Reslice

matlabbatch{1}.spm.spatial.realign.estwrite.data = {cellstr(spm_select('ExtFPListRec', func_path, '^SUBNUM_task-stopsignal_bold\.nii$', [1:184]))}';
...
matlabbatch{2}.spm.spatial.coreg.estimate.source = {fullfile(anat_path, 'SUBNUM_T1w.nii,1')};
...
matlabbatch{3}.spm.spatial.preproc.tissue(1).tpm = {fullfile(SPM_path, 'tpm/TPM.nii,1')};
matlabbatch{3}.spm.spatial.preproc.tissue(1).ngaus = 1;
matlabbatch{3}.spm.spatial.preproc.tissue(1).native = [1 0];
matlabbatch{3}.spm.spatial.preproc.tissue(1).warped = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(2).tpm = {fullfile(SPM_path, 'tpm/TPM.nii,2')};
matlabbatch{3}.spm.spatial.preproc.tissue(2).ngaus = 1;
matlabbatch{3}.spm.spatial.preproc.tissue(2).native = [1 0];
matlabbatch{3}.spm.spatial.preproc.tissue(2).warped = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(3).tpm = {fullfile(SPM_path, 'tpm/TPM.nii,3')};
matlabbatch{3}.spm.spatial.preproc.tissue(3).ngaus = 2;
matlabbatch{3}.spm.spatial.preproc.tissue(3).native = [1 0];
matlabbatch{3}.spm.spatial.preproc.tissue(3).warped = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(4).tpm = {fullfile(SPM_path, 'tpm/TPM.nii,4')};
matlabbatch{3}.spm.spatial.preproc.tissue(4).ngaus = 3;
matlabbatch{3}.spm.spatial.preproc.tissue(4).native = [1 0];
matlabbatch{3}.spm.spatial.preproc.tissue(4).warped = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(5).tpm = {fullfile(SPM_path, 'tpm/TPM.nii,5')};
matlabbatch{3}.spm.spatial.preproc.tissue(5).ngaus = 4;
matlabbatch{3}.spm.spatial.preproc.tissue(5).native = [1 0];
matlabbatch{3}.spm.spatial.preproc.tissue(5).warped = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(6).tpm = {fullfile(SPM_path, 'tpm/TPM.nii,6')};
